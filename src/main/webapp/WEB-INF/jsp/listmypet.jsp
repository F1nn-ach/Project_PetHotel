			...
			<div class="content-card">
				<div class="header">
					...
					<div class="title-section">
						...
						<a href="pet_register" class="add-pet-button"> <i
							class="fas fa-plus"></i> เพิ่มสัตว์เลี้ยง
						</a>
					</div>
				</div>
				...
				<div class="navigation-links">
					<a href="/Project_PetHotel/" class="nav-button"> <i
						class="fas fa-home"></i> กลับไปหน้าหลัก
					</a>
				</div>
			</div>
		</div>
